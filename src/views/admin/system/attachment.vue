  ...
  <d2-container>
    ...
    <div class="operation-box">
      <el-form :inline="true" class="demo-form-inline" slot="header">
        ...
        <el-form-item>
          <el-button size="small" @click="reset"><i class="el-icon-refresh"></i> 刷新</el-button>
        </el-form-item>
      </el-form>
    </div>
...
<script>
import { getImagesByPage, multiDelImages, uploadImgToAttachment } from '@api/admin/picture'
