        ...
        <el-form>
          ...
          >
            <el-switch
              ...
              v-model="openCommentModel"
            ></el-switch>
          </el-form-item>
        </el-form>
        <div v-if="openCommentModel">
          <el-form
...
export default {
  ...
  mounted() {
    console.log(this.openCommentModel, this.is_public)
  },
  methods: {
    // tab 切换事件
    handleTabClick(tab) {
        ...
        if (valid) {
          ...
          setTimeout(() => {
            saveLocalCommentSetting(this.localCommentForm)
              .then(res => {
                this.$message.warning(`${res.msg}, 该功能未开发完全`);
