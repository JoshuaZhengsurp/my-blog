<template>
  <d2-container>
    <template slot="header">用户 / 评论 （开发ing）</template>
    <d2-crud
      ref="d2Crud"
      :options="options"
      :loading="loading"
...
<script>
import { addComment, deleteComment, getCommentsByPage, updateComment } from '@/api/admin/comment'
import nickName from '@/components/admin/comment/nickName'
import date from '@/components/admin/common/date'
import state from '@/components/admin/comment/state'
import tableHandler from '@/components/admin/comment/tableHandler'
import editVditor from '@/components/admin/post/editVditor'
import { getAllUsers } from '@/api/admin/user'
import { getSysSettingItem } from '@api/admin/sys'
