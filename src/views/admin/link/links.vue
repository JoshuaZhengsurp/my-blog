...
<script>
import { createLink, deleteLink, getLinksByPage, multiDelLinks, updateLink } from '@api/admin/link'
import { addLinkCategory, getAllCategories } from '@api/admin/category'
import tableHandler from '@/components/admin/link/tableHandler'
import tag from '@/components/admin/link/tag'
