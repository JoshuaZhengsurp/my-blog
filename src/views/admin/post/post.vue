...
<script>
import addEditor from '@/components/admin/post/addVditor'
import editEditor from '@/components/admin/post/editVditor'
import singleTag from '@/components/admin/post/singleTag'
import multiTag from '@/components/admin/post/multiTag'
import state from '@/components/admin/post/state'
import tableHandler from '@/components/admin/post/tableHandler'
import postTitle from '@/components/admin/post/postTitle'
import attachDrawer from '@/components/admin/common/attachDrawer'
import { addArticleCategory, getAllCategories, getAllParentCategories } from '@/api/admin/category'
import { addTag, getAllTags } from '@/api/admin/tag'
import {
  addPost,
  deletePost,
  getPostById,
