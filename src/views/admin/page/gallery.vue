...
import { createGallery, getGalleriesByPage, multiDelGalleries, updateGallery } from '@api/admin/gallery'
import { addGalleryCategory, deleteCategory, getAllCategories, updateGalleryCategory } from '@api/admin/category'
