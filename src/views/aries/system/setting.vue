  ...
  <d2-container>
    ...
    >
      <el-tab-pane label="网站设置" style="width: 500px">
        ...
        >
          ...
          <el-form-item label="SEO 关键词" prop="seo_key_words">
            <el-input
              size="small"
              v-model="siteForm.seo_key_words"
              type="text"
              autocomplete="off"
              placeholder="关键词以逗号隔开，如 Java,python,Golang"
            ></el-input>
          </el-form-item>
          <el-form-item label="备案号" prop="record_number">
            <el-input
              size="small"
              :rows="5"
              v-model="siteForm.record_number"
              type="text"
              autocomplete="off"
              placeholder="备案号"
            ></el-input>
          ...
          <el-form-item label="全局 footer" prop="footer_content">
            <el-input
              size="small"
              :rows="5"
              v-model="siteForm.footer_content"
              type="textarea"
              autocomplete="off"
              placeholder="全局 footer"
            ></el-input>
          </el-form-item>
          <el-form-item>
            <el-button
          ...
          <el-tab-pane label="邮件发送测试">
            ...
            >
              ...
              <el-form-item label="接收邮箱" prop="receive_email">
                <el-input
                  size="small"
                  v-model="emailSendForm.receive_email"
                  type="email"
                  autocomplete="off"
                  placeholder="接收邮箱"
                ></el-input>
              ...
              <el-form-item>
                <el-button
                  size="small"
                  type="primary"
                  :loading="btn.emailSendLoading"
                  @click="saveEmailSendForm"
                  >发送
                </el-button>
              </el-form-item>
            </el-form>
      ...
      <el-tab-pane label="图床设置" style="width: 500px">
        ...
        >
          <el-form-item label="存储类型" prop="storage_type">
            <el-select
              size="small"
              v-model="storageForm.storage_type"
              placeholder="请选择存储类型"
      ...
      <el-tab-pane label="评论设置" style="width: 500px">
        <el-form
          :model="commentPlugInForm"
          :rules="commentPlugInFormRules"
          ref="commentPlugInForm"
          label-width="130px"
        >
          <el-form-item label="评论组件" prop="plug_in">
            <el-select
              size="small"
              v-model="commentPlugInForm.plug_in"
              placeholder="请选择评论组件"
        ...
        <el-form
          ref="localCommentForm"
          :model="localCommentForm"
          :rules="localCommentFormRules"
          v-show="commentPlugInForm.plug_in === 'local-comment'"
          label-width="130px"
        >
          <el-form-item label="评论功能" prop="is_on">
            <el-switch
              ...
              active-value="1"
              inactive-value="0"
              v-model="localCommentForm.is_on"
            ></el-switch>
          </el-form-item>
          <el-form-item label="评论审核" prop="is_review_on">
            <el-switch
              ...
              active-value="1"
              inactive-value="0"
              v-model="localCommentForm.is_review_on"
            ></el-switch>
          </el-form-item>
          <el-form-item label="回复后邮件通知" prop="is_reply_on">
            <el-switch
              ...
              active-value="1"
              inactive-value="0"
              v-model="localCommentForm.is_reply_on"
            ></el-switch>
          </el-form-item>
          <el-form-item label="每页评论个数" prop="page_size">
            <el-input
              size="small"
              v-model="localCommentForm.page_size"
              type="number"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item>
            <el-button
              size="small"
              type="primary"
              :loading="btn.localCommentSaveLoading"
              @click="saveLocalCommentForm"
              >保存
            </el-button>
          </el-form-item>
        </el-form>
        ...
        <el-form
          ref="twikooForm"
          :model="twikooForm"
          v-show="commentPlugInForm.plug_in === 'twikoo-comment'"
          :rules="twikooFormRules"
          label-width="130px"
        >
          <el-form-item label="Twikoo 部署教程:">
            <label style="color: gray">
              <a
                ...
                target="_blank"
                >https://twikoo.js.org/quick-start.html</a
              >
            </label>
          </el-form-item>
          ...
          <el-form-item>
            <el-button
              size="small"
              type="primary"
              :loading="btn.twikooSaveLoading"
              @click="saveTwikooForm"
              >保存
            </el-button>
          </el-form-item>
        </el-form>
      ...
      <el-tab-pane label="参数设置" style="width: 500px">
        ...
        >
          <el-form-item label="首页每页条数" prop="index_page_size">
            <el-input
              size="small"
              v-model="paramForm.index_page_size"
              type="number"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="归档页每页条数" prop="archive_page_size">
            <el-input
              size="small"
              v-model="paramForm.archive_page_size"
              type="number"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="站点地图每页条数" prop="site_map_page_size">
            <el-input
              size="small"
              v-model="paramForm.site_map_page_size"
              type="number"
              autocomplete="off"
            ></el-input>
          </el-form-item>
        ...
        <el-form ref="socialForm" :model="socialForm" label-width="130px">
          ...
          <el-form-item>
            <el-button
              size="small"
              type="primary"
              :loading="btn.socialSaveLoading"
              @click="saveSocialInfoForm"
              >保存
            </el-button>
          </el-form-item>
        </el-form>
    ...
    return {
      ...
      siteRules: {
        ...
        static_root: [
          {
            max: 255,
            message: "静态资源根目录长度不能超过 255",
            trigger: "blur"
          },
          {
            type: "url",
            message: "静态资源根目录必须为有效的 URL",
            trigger: "blur"
          }
        ],
        site_desc: [
        ...
        footer_content: [
          {
            max: 1000,
            message: "全局 footer 脚本长度不能超过 1000",
            trigger: "blur"
          }
        ]
      },
      ...
      localCommentFormRules: {
        ...
        is_review_on: [
          {
            required: true,
            message: "请选择是否开启评论审核功能",
            trigger: "blur"
          }
        ]
      },
      twikooFormRules: {
        env_id: [{ required: true, message: "请输入环境 id", trigger: "blur" }]
      },
      paramFormRules: {},
      btn: {
